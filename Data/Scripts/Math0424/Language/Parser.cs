...
namespace AnimationEngine.Language
{
    internal class Parser
    {
        ...
        private Expression ParseExpression(ref int index, ref Token[] toks)
        {
        ...
        private Call[] ParseBody(ref Token[] toks)
        {
