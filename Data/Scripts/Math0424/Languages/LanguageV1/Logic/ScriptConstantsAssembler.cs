...
namespace AnimationEngine.LogicV1
{
    ...
    {
        public static ScriptConstants Assemble(Script script, out string blockId)
        {
        ...
        private static void AssembleCall(ref Caller call, Call exp, string name, Script script)
        {
            switch(exp.Type)
            {
        ...
        private static Argument[] AssembleExpression(Call exp, Script script)
        {
        ...
        private static void AssembleObject(Entity ent, ScriptConstants constants, Script script)
        {
            switch(ent.Type)
            {
