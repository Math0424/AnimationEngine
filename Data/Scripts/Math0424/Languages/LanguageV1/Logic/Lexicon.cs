...
namespace AnimationEngine.LogicV1
{
    ...
    {
        public static bool IsValidMethodName(Expression exp, out MethodDef? def)
        {
            def = null;
        ...
        public static bool IsValidMethod(Expression exp)
        {
            foreach(var x in DefinedMethods)
            {
                if (x.Name.Equals(exp.Title.Value.ToString().ToLower()))
        ...
        public static void IsValidAction(ScriptAction act, ref Script script)
        {
